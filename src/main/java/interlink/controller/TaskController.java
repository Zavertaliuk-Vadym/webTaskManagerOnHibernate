...
public class TaskController {
    ...
    //about task
    @RequestMapping(value = "/task/{taskId}/description", method = RequestMethod.GET)
    ...
    //New Task
    @RequestMapping(value = "/task/newTask", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/task/{taskId}/changeTask", method = RequestMethod.GET)
...
//switch status
    ...
    //changeTask
    @RequestMapping(value = "/task/{taskId}/changeTask", method = RequestMethod.POST)
